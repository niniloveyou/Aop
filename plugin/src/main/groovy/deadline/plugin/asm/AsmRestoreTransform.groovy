...
public class AsmRestoreTransform extends Transform {

    Project project

    def AsmRestoreTransform(Project project) {
        this.project = project
    }

    @Override
    String getName() {
        return "AsmRestoreTransform"
    }
                        ...
                        directoryInput.file.eachFileRecurse {
                            File file ->
                                ...
                                if (name.endsWith(".class") && !name.startsWith("R\$") &&
                                    ...
                                    ClassVisitor cv = new RestoreVisitor(className, classWriter)
